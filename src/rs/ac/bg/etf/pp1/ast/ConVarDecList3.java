...
public class ConVarDecList3 extends ConVarDecList {

    private ConVarDecList ConVarDecList;
    private EnumDeclList EnumDeclList;

    public ConVarDecList3 (ConVarDecList ConVarDecList, EnumDeclList EnumDeclList) {
