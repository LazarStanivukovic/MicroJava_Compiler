...
public class ConVarDecList2 extends ConVarDecList {

    private ConVarDecList ConVarDecList;
    private VarDeclList VarDeclList;

    public ConVarDecList2 (ConVarDecList ConVarDecList, VarDeclList VarDeclList) {
