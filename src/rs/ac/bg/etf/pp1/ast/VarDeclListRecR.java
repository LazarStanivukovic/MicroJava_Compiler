...
public class VarDeclListRecR extends VarDeclListRec {

    private VarDeclListRec VarDeclListRec;
    private VarDeclList VarDeclList;

    public VarDeclListRecR (VarDeclListRec VarDeclListRec, VarDeclList VarDeclList) {
